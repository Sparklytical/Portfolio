...
export default class IndexPage extends Component {
  render = () => {
    return (
      <Wrap
        pageBg={<PageBg />}
        description="Hi! 👋 I'm Mohd Kamran Tahir. I'm a Web Developer from Fatehpur. This is my portfolio website. Here you can see some of my work, articles & other information about me.">
        <div
          css={css`
            top: 47%;
            left: 25%;
          ...
          <h1 className="h1 m-0 font-weight-bold text-left">
            ...
            <div className="text-break">
              Web <span className="high">Developer</span>
