...
export default class AboutPage extends Component {
  render = () => {
    return (
      <Wrap
        pageBg={<PageBg />}
        title="About - Mohd Kamran Tahir"
        description="I'm Kamran Tahir. I'm a Web Developer based in Fatehpur, UP, India.">
        <div className="content-wrap">
          <div className="h1 font-weight-bold mb-5">
            Hi.
            <br />
            I'm <span className="high">Mohd Kamran Tahir</span>
            <span className="blinker">.</span>
            <br />A <span className="high">Web Developer</span>
            <br /> based in
            <span className="brand-light"> Fatehpur, UP, India</span>.
          </div>
